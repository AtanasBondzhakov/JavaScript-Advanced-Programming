...
<tbody>
<tr class="odd">
<td><p>const library = {</p>
<p>print: function () {</p>
<p>console.log(`${this.name} is printing a page`);</p>
<p>},</p>
<p>scan: function () {</p>
<p>console.log(`${this.name} is scanning a document`);</p>
<p>},</p>
<p>play: function (artist, track) {</p>
<p>console.log(`${this.name} is playing '${track}' by ${artist}`);</p>
<p>},</p>
<p>};</p>
<p>const orders = [</p>
<p>{</p>
<p>template: { name: 'ACME Printer'},</p>
<p>parts: ['print']</p>
<p>},</p>
<p>{</p>
<p>template: { name: 'Initech Scanner'},</p>
<p>parts: ['scan']</p>
<p>},</p>
<p>{</p>
<p>template: { name: 'ComTron Copier'},</p>
<p>parts: ['scan', 'print']</p>
<p>},</p>
<p>{</p>
<p>template: { name: 'BoomBox Stereo'},</p>
<p>parts: ['play']</p>
<p>}</p>
<p>];</p>
<p>const products = factory(library, orders);</p>
<p>console.log(products);</p></td>
</tr>
<tr class="even">
<td><strong>Output</strong></td>
</tr>
...
<td><p>[</p>
<p>{</p>
<p>name: 'ACME Printer',</p>
<p>print: [Function: print]</p>
<p>},</p>
<p>{</p>
<p>name: 'Initech Scanner',</p>
<p>scan: [Function: scan]</p>
<p>},</p>
<p>{</p>
<p>name: 'ComTron Copier',</p>
<p>scan: [Function: scan],</p>
<p>print: [Function: print]</p>
<p>},</p>
<p>{</p>
...
<p>myCar.checkDistance(0.2);</p></td>
<td><p>Beep!</p>
<p>Beep! Beep!</p></td>
</tr>
<tr class="even">
